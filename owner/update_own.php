                ...
                <tr>
                    <td><table width="500" border="0" align="center">
                            ...
                            <tr>
                                ...
                                <td><?php
                                    $rdo = "";
                                    if (isset($row['sex_owner'])) {
                                        $rdo = $row['sex_owner'];
                                    }
                                    ?><input type="radio" name="sex_owner" id="radio" value="ชาย"<?php if ($rdo == "ชาย") echo "checked"; ?> />ชาย 
                                    <input type="radio" name="sex_owner" id="radio2" value="หญิง"<?php if ($rdo == "หญิง") echo "checked"; ?> />หญิง</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    ...
                                    <?php echo "<td align='left'><a href ='ochange_pass.php?user_owner=$row[user_owner]&id_owner=$row[id_owner]'>แก้ไขรหัส</a></td>"; ?>
                                </td>
                            </tr>
                        </table>
                    </td>
