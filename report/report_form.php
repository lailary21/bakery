...
//$yearconvert = (explode("-", $yearfirst['datetime']));
$yearnow = date("Y-M-D");
?>
<html>
    <head>
    ...
    <script src="../jquery/jquery-1.12.0.min.js" type="text/javascript">
    </script>
    <script>
                ...
                <tr>
                    ...
                    <td width="1000" >                              
                        <table width="500" border="0" border="center" align="center" bgcolor="#FFFFCC">
                            ...
                            <tr><td align="right">ประเภทรายงาน : </td>
                                <td><select name="report">
                                    ...
                                    </select><a style="color: crimson"> *</a></td>
                            </tr>
                            <tr><td align="right">วันที่เริ่มต้น : </td>
                                <td><input type="date" id="datetimepicker1" name="datestart"/><a style="color: crimson"> *</a></td>
                            </tr>
                            <tr><td align="right">วันที่สิ้นสุด : </td>
                                <td><input type="date" id="datetimepicker2" name="dateend"/><a style="color: crimson"> *</a></td>
                            </tr>
                            <script>
                                    $(document).ready(function(){
                            ...
                            <tr><td align="center">
                                <td><input type="submit" id="print" name="submit"  value="submit"> 
