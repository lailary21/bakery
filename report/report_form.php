    ...
    <body>
        ...
        <table width="1300" height="200" border="0" color="#FFFFFF" align="center"> <!--ตารางใหญ่!-->
            <tr>
                ...
                <td width="1000">
                    <form id="form1"name="form1"method="post"action="action_report.php"target="_blank">
                        <table width="500"border="0"border="center"align="center" bgcolor="#FFFFCC">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" required readonly id="startDatePicker"name="startDatePicker"/>
                                    <a style="color: crimson"> *</a></td>
                            </tr>
                            <tr>
                                <td align="right">วันที่สิ้นสุด :</td>
                                <td>
                                    <input type="text" required readonly id="endDatePicker"name="endDatePicker"/>
                                    <a style="color: crimson"> *</a></td>
                            </tr>
                            <tr>
                                <td align="center">
                                <td>
                                    <input type="submit" id="print"name="submit"value="submit"/>
                                    <input type="reset"id="bt2"name="reset"value="cancel"/>
                                </td>
                            </tr>
                        </table>
                    </form>
